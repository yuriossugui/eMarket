...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/movement-inbound.css') }}">
@endsection

<div class="d-flex justify-content-center mt-2">
    <h3>Histórico de entrada de produtos</h3>
</div>
...
<div id="mainContainer" class="card p-2 m-2">
    ...
    <div class="modal fade" id="createProductForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-sm">
                ...
                <form action="/admin/register-entry" method="post">
                    @csrf
    ...
    @section('js')
        ...
        <script src="{{ asset('assets/js/movement-inbound.js') }}"></script>
    @endsection
